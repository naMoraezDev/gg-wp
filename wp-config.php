...
// Configuração WP Stateless para Google Cloud Storage
define('WP_STATLESS_MEDIA', true);
...
define('WP_STATLESS_MEDIA_CREATE_BUCKET', false); // Não cria o bucket automaticamente
define('WP_STATLESS_MEDIA_CACHE_CONTROL', 'public,max-age=3600');
define('WP_STATLESS_UPLOAD_LOCAL', true); // Permite upload local para miniaturas, se necessário
...
// Configuração de HTTPS para quando o protocolo for 'https'
